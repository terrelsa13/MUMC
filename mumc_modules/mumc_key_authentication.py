...
def authenticate_user_by_name(admin_username,admin_password,the_dict):
    ...
    req=build_emby_jellyfin_request_message(url,the_dict,data=values,method='POST',client='mumc_auth.py',device='Multi-User Media Cleaner Auth',deviceId='MUMC Auth')
...
def get_labelled_authentication_keys(authenticated_user_data,the_dict):
    ...
    req=build_emby_jellyfin_request_message(url,the_dict,token=token,client='mumc_auth.py',device='Multi-User Media Cleaner Auth',deviceId='MUMC Auth')
...
def create_labelled_authentication_key(authenticated_user_data,the_dict):
    ...
    req=build_emby_jellyfin_request_message(url,the_dict,token=token,client='mumc_auth.py',device='Multi-User Media Cleaner Auth',deviceId='MUMC Auth',method='POST')
...
def delete_labelled_authentication_key(key_to_delete,authenticated_user_data,the_dict):
    ...
    req=build_emby_jellyfin_request_message(url,the_dict,token=token,method='DELETE',client='mumc_auth.py',device='Multi-User Media Cleaner Auth',deviceId='MUMC Auth')
