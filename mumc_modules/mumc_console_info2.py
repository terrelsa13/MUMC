...
from mumc_modules.mumc_days_since2 import get_days_since_played2,get_days_since_created2
...
def build_print_media_item_details(item,var_dict,the_dict):
    ...
    days_since_played=get_days_since_played2(item['UserData']['LastPlayedDate'],the_dict)
    days_since_created=get_days_since_created2(item['DateCreated'],the_dict)
...
def print_post_processing_started2(the_dict,postproc_dict):
    strings_list_to_print=''
...
def print_post_processing_verbal_progress2(the_dict,postproc_dict,prost_processing_step):
    strings_list_to_print=''
...
def print_post_processing_verbal_progress_min_episode2(the_dict,postproc_dict):
    strings_list_to_print=''
...
def print_post_processing_completed2(the_dict,postproc_dict):
    strings_list_to_print=''
