...
############# END OF SCRIPT #############
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner_config.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ cat media_cleaner_config.py
#----------------------------------------------------------#
...
not_played_age_episode=0
not_played_age_video=0
not_played_age_trailer=0
not_played_age_audio=0
...
# (00000001 - default)
#----------------------------------------------------------#
keep_favorites_advanced='00111111'
...
# (00000000 - default)
#----------------------------------------------------------#
keep_favorites_advanced_any='00111111'
...
# (0 : default)
#----------------------------------------------------------#
multiuser_whitelist_advanced=2
...
#----------------------------------------------------------#
max_age_movie=1000
max_age_episode=2000
max_age_video=3000
max_age_trailer=4000
max_age_audio=6000
...
#----------------------------------------------------------#
access_token='a7531edc166e49ec9f9410f4b95bc5bf'

#----------------------------------------------------------#
# User key(s) of account(s) to monitor media items; chosen during setup
#----------------------------------------------------------#
user_keys='["fcc078ae1d8047458d2e3ca459e88d09", "64fb67457ed944a0bfe01d4e957f38e2"]'
...
#----------------------------------------------------------#
user_wl_libs='["smb://hieroglyph/Pharaoh/xbmc/TV,smb://hieroglyph/Pharaoh/xbmc/Movies,smb://hieroglyph/Pharaoh/xbmc/Albums", "smb://hieroglyph/Pharaoh/xbmc/TV,smb://hieroglyph/Pharaoh/xbmc/Movies,smb://hieroglyph/Pharaoh/xbmc/Albums2,smb://hieroglyph/Pharaoh/xbmc/Albums"]'
...
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ ^C
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py.copy 
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
...
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner_config.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ cp media_cleaner.py media_cleaner.py.
media_cleaner.py.copy  media_cleaner.py.orig  
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ cp media_cleaner.py media_cleaner.py.copy 
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
...
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ nano media_cleaner.py
hieroglyph@hieroglyph:/opt/media_cleaner_jelly$ cat media_cleaner.py
#!/usr/bin/env python3
                ...
                for item in data['Items']:
                    ...
                    if ((item['Type'] == 'Video') and (itemIsMonitored)):
                        ...
                        if (
                           ...
                           ((not bool(cfg.max_keep_favorites_video)) or (not item['UserData']['IsFavorite']))) and
                           (not itemIsWhiteListed))
                           ):
                            try:
                                if (does_key_exist(item['UserData'], 'LastPlayedDate')):
                ...
                for item in data['Items']:
                    ...
                    if ((item['Type'] == 'Trailer') and (itemIsMonitored)):
                        ...
                        if (
                           ...
                           ((not bool(cfg.max_keep_favorites_trailer)) or (not item['UserData']['IsFavorite']))) and
                           (not itemIsWhiteListed))
                           ):
                            try:
                                if (does_key_exist(item['UserData'], 'LastPlayedDate')):
