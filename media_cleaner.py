...
def get_auth_key(server_url, username, password, server_brand):
    ...
    headers = {xAuth : 'Emby UserId="' + username  + '", Client="media_cleaner.py", Device="Multi-User Media Cleaner", DeviceId="MUMC", Version="2.0.1 Beta", Token=""', 'Content-Type' : 'application/json'}
